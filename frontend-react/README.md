...
- Use [ESLint](https://eslint.org), [stylelint](https://stylelint.io) and [Prettier](https://prettier.io) on VSCode and before you commit with [Husky](https://github.com/typicode/husky) and [lint-staged](https://github.com/okonet/lint-staged). Husky was disabled in order to work with backend
...
```
npx degit wtchnm/Vitamin#main proyecto-Base
```
